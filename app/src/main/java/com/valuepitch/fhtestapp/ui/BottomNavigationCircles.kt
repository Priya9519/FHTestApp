package com.valuepitch.fhtestapp.ui
...
class BottomNavigationCircles: BottomNavigationView {
    ...
    private fun getColors() {
        disabledColor = ContextCompat.getColor(context, R.color.gray)
        circleColor = ContextCompat.getColor(context, R.color.peach)
    ...
    private fun animateBottomIcon(itemId: Int): Boolean {
        ...
        if (itemId != currentNavigationItemId) {
            ...
            val circleDrawable = ContextCompat.getDrawable(context, R.drawable.peach_circle)
